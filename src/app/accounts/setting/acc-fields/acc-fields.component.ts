...
@Component({
  selector: 'app-acc-fields',
  templateUrl: './acc-fields.component.html',
  styleUrls: ['./acc-fields.component.css']
})
export class AccFieldsComponent implements OnInit {
  ...
  async save() {
    ...
    this.field['domain_code'] = 'ACCOUNT';
