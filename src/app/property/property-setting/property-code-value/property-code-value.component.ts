...
@Component({
  selector: 'app-property-code-value',
  templateUrl: './property-code-value.component.html',
  styleUrls: ['./property-code-value.component.css']
})
export class PropertyCodeValueComponent implements OnInit {
