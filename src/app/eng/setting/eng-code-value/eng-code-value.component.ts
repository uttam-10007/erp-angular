...
@Component({
  selector: 'app-eng-code-value',
  templateUrl: './eng-code-value.component.html',
  styleUrls: ['./eng-code-value.component.css']
})
export class EngCodeValueComponent implements OnInit {
