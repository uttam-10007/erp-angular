...
export class SettingService {
  ...
  async getunit(b_acct_id) {
    const resp = await this.http.get<any>(this.main.httpUrl + '/eng/unitconversion/getunit' + b_acct_id).toPromise().then(res => {
      return res;
    });
    return resp;
  }
  async deleteunit(obj) {
    const resp = await this.http.delete<any>(this.main.httpUrl + '/eng/unitconversion/deleteunit' + obj).toPromise().then(res => {
      return res;
    });
    return resp;
  }
  async getxFieldCodeValues(obj) {
    const resp = await this.http.get<any>(this.main.httpUrl + '/eng/codeValue/getFieldCodeValues' + JSON.stringify(obj)).toPromise().then(res => {
      return res;
    });
    return resp;
  }
  async insertunit(obj) {
    const resp = await this.http.post<any>(this.main.httpUrl + '/eng/unitconversion/createeunit', obj).toPromise().then(res => {
      return res;
    });
    return resp;
  }
  async updateunit(obj) {
    const resp = await this.http.put<any>(this.main.httpUrl + '/eng/unitconversion/updateunit', obj).toPromise().then(res => {
      return res;
    });
    return resp;
  }
  ...
  async createRefApplication(obj) {
    const resp = await this.http.post<any>(this.main.httpUrl + '/eng/applicationRef/createRefApplication', obj).toPromise().then(res => {
      return res;
    });
    return resp;
  }
  async updateRefApplication(obj) {
    const resp = await this.http.put<any>(this.main.httpUrl + '/eng/applicationRef/updateRefApplication', obj).toPromise().then(res => {
      return res;
    });
    return resp;
  }
  async deleteRefApplication(obj){
    const resp = await this.http.delete<any>(this.main.httpUrl + '/eng/applicationRef/deleteRefApplication'+obj).toPromise().then(res => {
      return res;
    });
    return resp;
  }
